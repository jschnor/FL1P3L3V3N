<?php
// from http://ca2.php.net/manual/en/function.quoted-printable-encode.php#100091 and #97230
if (!function_exists('quoted_printable_encode')) {
  function quoted_printable_encode($input) {
     $line_max = 75; // don't let this be set as arg since it's not compatible with PHP 5.3 built-in function
